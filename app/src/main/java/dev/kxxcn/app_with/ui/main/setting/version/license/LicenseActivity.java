package dev.kxxcn.app_with.ui.main.setting.version.license;
...
public class LicenseActivity extends AppCompatActivity {
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		tv_title.setText(getString(R.string.text_license));
		tv_raw.setText(SystemUtils.getRawFile(this, R.raw.license, CHARSET_UTF8));
	}
